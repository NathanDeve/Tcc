...
<html>
    ...
    <body>
        ...
        $reg = $resultado->fetch_row();
            ...
            echo '<tr>';
            echo "<td class='text'><img src='uploads/$reg[8]'</td>";
            echo "<td class='text'>{$reg[0]}</td>";
            echo "<td class='text'>{$reg[1]}</td>";
            echo "<td class='text'>{$reg[2]}</td>";
            echo "<td class='text'>{$reg[3]}</td>";
            echo "<td class='text'>{$reg[4]}</td>";
            echo "<td class='text'>{$reg[5]}</td>";
            echo "<td class='text'>{$reg[6]}</td>";
            echo "<td class='text'>{$reg[7]}</td>";
            echo '</tr>';
   }
   echo '</table>';
}
